...
# qfile = "admix/all-pops.BovineHD.pruned.10.Q"
# kprior = "admix/all-pops.BovineHD.pruned.sorted.9.Q"
# qsorted = "admix/all-pops.BovineHD.pruned.sorted.10.Q"
...
if (length(dat2) < 10) {
  ...
  idx <- which(sums == min(sums), arr.ind = TRUE)
